...
<script type="text/javascript">
  $(document).ready(function() {
	...
	$("#adminpath").formValidator({onshow:"请输入后台登录地址",onfocus:"请输入后台登录地址",oncorrect:"格式正确"}).regexValidator({regexp:"username",datatype:"enum",onerror:"只能为数字字母组合"})	
	...
	<div class="content">
    	<table width="100%" cellspacing="1" cellpadding="0">
			  <tr>
				...
				<td><input name="adminpath" id="adminpath" type="text" value="jong" class="input-text" /></td>
			  </tr>
			  <tr>
				<td colspan="2" align="center">后台地址设置提示：同文件夹命名规则，例如:jong 安装完成后后台登录地址即为 <?php echo $siteurl ?>jong
				  </td>
			  </tr>
			  <tr>
			  ...
			  <tr>
				...
				<td><input name="password" type="password" id="password" value="xiaoyu" class="input-text" /></td>
			  </tr>
			  <tr>
				<th align="right">确认密码：</th>
				<td><input name="pwdconfirm" type="password" id="pwdconfirm" value="xiaoyu" class="input-text" /></td>
			  </tr>
			  <tr>
				<th align="right">管理员E-mail：</th>
				<td><input name="email" type="text" id="email" value="1@1.cc" class="input-text" />
...
<fieldset>
	...
	<div class="content">
    	<table width="100%" cellspacing="1" cellpadding="0">
			  ...
			  <tr>
				<th width="20%" align="right">静态文件目录：</th>
				<td><input name="stylefile" type="text" id="stylefile" value="statics" class="input-text" /></td>
			  </tr>
			  <tr>
			  <th align="right">是否开启验证码：</th>
			  <td><input name="code" type="radio" id="code" value="1" 
			  <?php if($code==1) echo '  checked="checked" '?>/>是&nbsp;&nbsp;
			  <input name="code" type="radio" id="code" value="0" 
			  <?php if($code==0) echo '  checked="checked" '?>/>否
			  <img src="./images/help.png" style="cursor:pointer;" title="测试可关闭,上线建议开启。" align="absmiddle" /><span id='helpcode'></span>
			  <span id='helptablepre'></span></td>
			  </tr>
