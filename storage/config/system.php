...
return [
	...
	'defaultDatabase' => 'mysqli', //默认数据库
	//目录配置
	// 'assets' => 'assets',  //资源目录 语言 错误视图
	// 'store' => 'store',  //储存目录 配置 缓存 错误日志
	//入口配置
	'defaults' => 'index.php', //默认文档
	'api' => 'api.php', //默认API接口
...
// 'cookie_pre' => 'HNIUA_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
// 'app_path' => 'http://127.0.0.1:5006/',//动态域名配置地址
// 'statics_path' => '/statics/',//后台静态文件路径
...
// 'gzip' => 1, //是否Gzip压缩后输出
// 'auth_key' => 'OCy6lfIrARksdwINum8o', //密钥
...
// 'admin_url' => '',	//允许访问后台的域名
// 'admin_login_path' => 'login',//自定义的后台登录地址
];
